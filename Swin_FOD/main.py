...
parser.add_argument("--modality", default='fod', type=str, help="data modality is FODs.")
...
def main():
    ...
    args.logdir = "./runs/" + args.logdir + "_random_" + f"_{args.modality}_originstructure_" + time.strftime("%Y%m%d-%H%M%S")
    if args.distributed:
...
def main_worker(gpu, args):
    ...
    dice_acc = ConfusionMatrixMetric(
...
# CUDA_VISIBLE_DEVICES=1 python main.py --batch_size=4 --logdir=unetr_test --optim_lr=1e-4 --lrschedule=warmup_cosine --save_checkpoint --noamp --modality fod
