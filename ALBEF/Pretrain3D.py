...
def main(args, config):
    ...
    data_loader = create_loader(datasets,samplers,batch_size=[config['batch_size']], num_workers=[8], is_trains=[True], collate_fns=[None])[0]
...
# python -m torch.distributed.launch --nproc_per_node=6 --use_env Pretrain3D.py --config ./configs/Pretrain3D.yaml --output_dir output/Pretrain3D
# CUDA_VISIBLE_DEVICES=1,2 torchrun --nproc_per_node=2 Pretrain3D.py --config ./configs/Pretrain3D.yaml --output_dir output/Pretrain3D
